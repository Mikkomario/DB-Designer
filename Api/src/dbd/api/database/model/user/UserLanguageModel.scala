...
/**
  ...
  * @since 2.5.2020, v2
  */
case class UserLanguageModel(id: Option[Int] = None, userId: Option[Int] = None, languageId: Option[Int] = None) extends Storable
{
	import UserLanguageModel._
	
	override def table = UserLanguageModel.table
