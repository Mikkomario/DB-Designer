...
object LinkConfigurationModel extends FromRowModelFactory[database.LinkConfiguration] with Deprecatable with FromRowFactoryWithTimestamps[database.LinkConfiguration]
{
	// IMPLEMENTED	---------------------------
 ...
 */
case class LinkConfigurationModel(id: Option[Int] = None, linkId: Option[Int] = None, linkType: Option[LinkType] = None,
...
{
	override def factory = LinkConfigurationModel
