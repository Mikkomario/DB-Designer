...
import dbd.core.model.existing.organization.InvitationResponse
...
/**
  ...
  * @since 6.5.2020, v2
  */
object DbInvitation extends SingleModelAccess[existing.organization.Invitation]
{
	// IMPLEMENTED	---------------------------
	
	override def factory = organization.InvitationModel
	...
	class SingleInvitation(invitationId: Int)
		extends SingleIdModelAccess[existing.organization.Invitation](invitationId, DbInvitation.factory)
	{
		// COMPUTED	---------------------------
			...
			with UniqueAccess[InvitationResponse]
		{
			...
			override def factory = organization.InvitationResponseModel
