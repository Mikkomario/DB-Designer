...
import dbd.api.database.access.many.user.DbTaskTypes
import dbd.api.database.model.organization.{MemberRoleModel, MembershipModel, RoleRightModel}
...
/**
  ...
  * @since 5.5.2020, v2
  */
object DbMembership extends SingleModelAccess[existing.organization.Membership]
{
	// IMPLEMENTED	--------------------------
	...
	class SingleMembership(membershipId: Int) extends SingleIdModelAccess(membershipId, factory)
	{
		...
		private def rightsFactory = RoleRightModel
